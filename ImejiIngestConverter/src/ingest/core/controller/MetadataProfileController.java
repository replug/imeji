 ...
 * 
 */
package ingest.core.controller;
...
import ingest.core.xml.XmlHandler;
import ingest.core.zuse.beans.ZuseDCTermsBean;
import ingest.core.zuse.profiles.ZuseDCTermsProfile;
...
public class MetadataProfileController {
	 ...
	 * @throws Exception 
	 */
	public ProjectObject getProjectObject() throws Exception {
	 ...
	 * @throws JDOMException 
	 */
	public ProjectObject retrieveProjectObject(String fileName) throws JDOMException, IOException {
	 ...
	 * @throws IOException
	 */
	public ProjectObject retrieveProjectObject(File file) throws JDOMException, IOException {
		this.projectObject = XmlHandler.getProjectObject(file); 
		return this.projectObject;
	}
	
	public ProjectObject retrieveProjectObject(FileInputStream fileInputStream) throws JDOMException, IOException {
...
//				continue;
	 ...
	 * @return
	 */
	public ArrayList<MetadataProfile> getMetadataProfiles(ProjectObject projectObject) {
	 ...
	 * @return
	 */
	public ArrayList<MetadataProfile> getUniqueMetadataProfiles(ProjectObject projectObject) {
		ArrayList<MetadataProfile> metadataProfiles = new ArrayList<MetadataProfile>();
